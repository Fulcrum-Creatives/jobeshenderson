...
<div class="body__content">
	...
	<main id="main" itemprop="mainContentOfPage" role="main">
		...
		<div class="related-projects">
			<header class="section__header">
				<h2 class="section__heading related-projects__title"><?php _e( 'Environmental Projects', FCWPF_TAXDOMAIN ) ?></h2>
			</header>
			<?php
			...
			endwhile; endif; wp_reset_postdata();
			?>
			<a class="view-all" href="/services_performed/environmental/">View all environmental project case studies.</a>
		</div>
	</main>
</div>
<?php get_footer(); ?>